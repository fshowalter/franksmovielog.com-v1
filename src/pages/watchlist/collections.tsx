    ...
    return (
      <li className={listItemCss}>
        <Link
          ...
          to={`/watchlist/collections/${entity.slug}/`}
        >
          {entity.avatar && (
            <GatsbyImage
        ...
        <div className={listItemTitleCss}>
          <Link to={`/watchlist/collections/${entity.slug}/`}>
            {entity.name}
          </Link>
        </div>
        <Link
...
/**
 * Renders a page for watchlist collections.
 */
      ...
      <main className={containerCss}>
        <div className={leftCss}>
          <FilterPageHeader
            ...
            heading={
              <>
                <span className={pageHeaderSubCss}>Watchlist</span> Collections
              </>
            }
        ...
        <div className={rightCss}>
          <ul data-testid="collections-list" className={listCss}>
...
export const pageQuery = graphql`
  query {
    entity: allWatchlistEntitiesJson(
      ...
      filter: { entity_type: { eq: "collection" } }
    ) {
      nodes {
        name
        slug
