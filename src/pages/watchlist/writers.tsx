    ...
    return (
      <li className={listItemCss}>
        <Link
          ...
          to={`/watchlist/writers/${entity.slug}/`}
        >
          {entity.avatar && (
            <GatsbyImage
        ...
        <div className={listItemTitleCss}>
          <Link to={`/watchlist/writers/${entity.slug}/`}>{entity.name}</Link>
        </div>
        <Link
          to={`/watchlist/writers/${entity.slug}/`}
      ...
      <main className={containerCss}>
        <div className={leftCss}>
          <FilterPageHeader
            ...
            heading={
              <>
                <span className={pageHeaderSubCss}>Watchlist</span> Writers
              </>
            }
        ...
        <div className={rightCss}>
          <ul data-testid="writers-list" className={listCss}>
